from gazebo_adapter.util import *
import theano
...
class Network:
    def __init__(self, n_actions, observation_shape):
        ...
        self.load_flat_weights = theano.function([flat_weights_placeholder], updates=OrderedDict(zip(self.weights, assigns)))#dict(zip(self.weights, assigns)))
